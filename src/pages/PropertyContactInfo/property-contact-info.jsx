...
function PropertyContactInfo({ property }) {
        ...
        <StyledDetail>
          ...
          <div className="login">
            <div className="login__card">
              <p className="login__title">Contact information</p>
              <div>
                <div className="login__title-pink">Email</div>
                <div className="login__title-info">dude@greathouse.com</div>
              </div>
              <div>
                <div className="login__title-pink">Phone</div>
                <div className="login__title-info">999444333</div>
              </div>
            </div>
          </div>
        </StyledDetail>
